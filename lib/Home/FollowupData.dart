...
class Followupdata extends StatefulWidget {
  const Followupdata({Key? key}) : super(key: key);

  @override
  State<Followupdata> createState() => _DatascreenState();
}

class _DatascreenState extends State<Followupdata> {
  ...
  Future<void> fetchData() async {
    try {
      String url = 'https://tm.webbexindia.com/api/followupdata';
