...
class Dailycollection extends StatefulWidget {
  ...
  @override
  State<Dailycollection> createState() => _DatascreenState();
}

class _DatascreenState extends State<Dailycollection> {
  ...
  Future<void> fetchData() async {
    try {
      String url = 'https://tm.webbexindia.com/api/dailycollectiondata';
